...
from src.bigquery_writer       import write_to_bigquery
...
def main() -> None:
    ...
    if args.no_upload:
        ...
        print('Done. Run without --no-upload to write to BigQuery.')
        return
    ...
    print('All tables written. Looker Studio will read from BigQuery.')
